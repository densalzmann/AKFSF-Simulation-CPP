...
std::vector<double> generateSigmaWeights(unsigned int numStates)
{
    ...
    double w0 = kappa / (kappa + numStates);
    weights.push_back(w0);
    double wi = 0.5 / (numStates + kappa);
